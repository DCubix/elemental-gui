...
public:
	void OnCreate(Application& app) {
		...
		// mainLayout->SetPadding(EdgeInsets::Zero);
		...
		// controlsFlex->SetPadding(EdgeInsets::All(6));
		...
		// slider.SetValue(50);
		// slider.SetStep(1);
		// slider.SetLocalBounds(Rectangle(0, 0, 0, 20));
		// slider.SetOnValueChange([&slider, &sliderLabel](float value) {
		// 	sliderLabel.SetText("Slider: " + std::to_string((int)value));
		// });
		// controls.Add(&slider);
		...
		// 	flex->SetPadding(EdgeInsets::All(4));
		// 	flex->SetGap(8);
