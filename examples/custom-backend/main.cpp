...
static const std::unordered_map<uint32_t, Key> KeyMap = {
    { SMOLK_A, Key::A }, { SMOLK_B, Key::B }, { SMOLK_C, Key::C }, { SMOLK_D, Key::D },
    { SMOLK_E, Key::E }, { SMOLK_F, Key::F }, { SMOLK_G, Key::G }, { SMOLK_H, Key::H },
    { SMOLK_I, Key::I }, { SMOLK_J, Key::J }, { SMOLK_K, Key::K }, { SMOLK_L, Key::L },
    { SMOLK_M, Key::M }, { SMOLK_N, Key::N }, { SMOLK_O, Key::O }, { SMOLK_P, Key::P },
    { SMOLK_Q, Key::Q }, { SMOLK_R, Key::R }, { SMOLK_S, Key::S }, { SMOLK_T, Key::T },
    { SMOLK_U, Key::U }, { SMOLK_V, Key::V }, { SMOLK_W, Key::W }, { SMOLK_X, Key::X },
    { SMOLK_Y, Key::Y }, { SMOLK_Z, Key::Z },

    { SMOLK_NUM0, Key::Num0 }, { SMOLK_NUM1, Key::Num1 }, { SMOLK_NUM2, Key::Num2 },
    { SMOLK_NUM3, Key::Num3 }, { SMOLK_NUM4, Key::Num4 }, { SMOLK_NUM5, Key::Num5 },
    { SMOLK_NUM6, Key::Num6 }, { SMOLK_NUM7, Key::Num7 }, { SMOLK_NUM8, Key::Num8 },
    { SMOLK_NUM9, Key::Num9 },

    { SMOLK_NUMPAD0, Key::Numpad0 }, { SMOLK_NUMPAD1, Key::Numpad1 }, { SMOLK_NUMPAD2, Key::Numpad2 },
    { SMOLK_NUMPAD3, Key::Numpad3 }, { SMOLK_NUMPAD4, Key::Numpad4 }, { SMOLK_NUMPAD5, Key::Numpad5 },
    { SMOLK_NUMPAD6, Key::Numpad6 }, { SMOLK_NUMPAD7, Key::Numpad7 }, { SMOLK_NUMPAD8, Key::Numpad8 },
    { SMOLK_NUMPAD9, Key::Numpad9 },

    { SMOLK_F1, Key::F1 }, { SMOLK_F2, Key::F2 }, { SMOLK_F3, Key::F3 }, { SMOLK_F4, Key::F4 },
    { SMOLK_F5, Key::F5 }, { SMOLK_F6, Key::F6 }, { SMOLK_F7, Key::F7 }, { SMOLK_F8, Key::F8 },
    { SMOLK_F9, Key::F9 }, { SMOLK_F10, Key::F10 }, { SMOLK_F11, Key::F11 }, { SMOLK_F12, Key::F12 },
    { SMOLK_F13, Key::F13 }, { SMOLK_F14, Key::F14 }, { SMOLK_F15, Key::F15 },

    { SMOLK_UP, Key::Up }, { SMOLK_DOWN, Key::Down }, { SMOLK_LEFT, Key::Left }, { SMOLK_RIGHT, Key::Right },
    { SMOLK_LSHIFT, Key::LeftShift }, { SMOLK_RSHIFT, Key::RightShift },
    { SMOLK_LCONTROL, Key::LeftControl }, { SMOLK_RCONTROL, Key::RightControl },
    { SMOLK_LALT, Key::LeftAlt }, { SMOLK_RALT, Key::RightAlt },
    { SMOLK_LSYSTEM, Key::LeftMeta }, { SMOLK_RSYSTEM, Key::RightMeta },

    { SMOLK_ESC, Key::Escape },
    { SMOLK_MENU, Key::Menu },
    { SMOLK_LBRACKET, Key::LeftBracket }, { SMOLK_RBRACKET, Key::RightBracket },
    { SMOLK_SEMICOLON, Key::Semicolon }, { SMOLK_COMMA, Key::Comma }, { SMOLK_PERIOD, Key::Period },
    { SMOLK_QUOTE, Key::Apostrophe }, { SMOLK_SLASH, Key::Slash }, { SMOLK_BACKSLASH, Key::Backslash },
    { SMOLK_TILDE, Key::Grave }, { SMOLK_EQUAL, Key::Equals }, { SMOLK_DASH, Key::Minus },
    { SMOLK_SPACE, Key::Space }, { SMOLK_RETURN, Key::Enter }, { SMOLK_BACKSPACE, Key::Backspace },
    { SMOLK_TAB, Key::Tab }, { SMOLK_PAGEUP, Key::PageUp }, { SMOLK_PAGEDOWN, Key::PageDown },
    { SMOLK_END, Key::End }, { SMOLK_HOME, Key::Home },
    { SMOLK_INSERT, Key::Insert }, { SMOLK_DELETE, Key::Delete },
    { SMOLK_ADD, Key::NumpadAdd }, { SMOLK_SUBSTRACT, Key::NumpadSubtract },
    { SMOLK_MULTIPLY, Key::NumpadMultiply }, { SMOLK_DIVIDE, Key::NumpadDivide },
    { SMOLK_ENTER, Key::NumpadEnter },
    { SMOLK_CAPSLOCK, Key::CapsLock }, { SMOLK_NUMLOCK, Key::NumLock },
    { SMOLK_PRINTSCREEN, Key::PrintScreen }, { SMOLK_SCROLLLOCK, Key::ScrollLock },
    { SMOLK_PAUSE, Key::Pause },
    { SMOLK_PLUS, Key::OemPlus }, { SMOLK_MINUS, Key::OemMinus },
};
...
public:
            ...
            SMOL_FRAME_EVENT_LOOP(frame, ev) {
                switch (ev.type) {
                    ...
                    case SMOL_FRAME_EVENT_MOUSE_BUTTON_DOWN:
                        sink.OnMouseButtonDown(windowId, ev.mouse.x, ev.mouse.y, SMOLButtonToMouseButton(ev.mouse.button));
                        break;
                    case SMOL_FRAME_EVENT_MOUSE_BUTTON_UP:
                        sink.OnMouseButtonUp(windowId, ev.mouse.x, ev.mouse.y, SMOLButtonToMouseButton(ev.mouse.button));
                        break;
    ...
    WindowHandle CreateWindow(const WindowConfig& config, WindowHandle parentHandle)
    {
        ...
        switch (config.style) {
            case WindowStyle::Fullscreen: break;
            case WindowStyle::TopLevel: break;
            case WindowStyle::Modal:
            case WindowStyle::Utility: flags |= SMOL_FRAME_CONFIG_ALWAYS_ON_TOP; break;
            case WindowStyle::Borderless: flags |= SMOL_FRAME_CONFIG_BORDERLESS; break;
        }
    ...
    WindowId GetWindowId(WindowHandle handle) const
    {
        return (WindowId)(uintptr_t)handle;
    }
...
class MyAdapter : public ApplicationAdapter {
public:
    void OnCreate(Application& app) override {
        auto window = app.CreateWindow({"SmolBackend Example", 800, 600});
...
int main() {
    Application app;
    app.SetBackend(std::make_unique<SmolBackend>());
    return app.Start(new MyAdapter());
}
#else
int main() {
